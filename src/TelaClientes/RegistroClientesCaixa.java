...
public class RegistroClientesCaixa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(txtNome);
        txtNome.setBounds(120, 70, 420, 30);
        jPanel4.add(txtTelefone);
        txtTelefone.setBounds(120, 20, 110, 30);

        getContentPane().add(jPanel4);
        jPanel4.setBounds(0, 70, 860, 120);
        ...
        jPanel6.setBounds(0, 190, 860, 280);

        setBounds(0, 0, 880, 518);
    ...
    private void GravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GravarActionPerformed
        ...
        if("".equals(telefone) || "".equals(endereco) || "".equals(numero) ){
            ...
            RegistroClientesCaixa.this.dispose();
